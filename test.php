...
$extraInfo['lang']                 = 'en';
$track = $track->createTracking('ruston','RK666201171CN',$extraInfo);

//4 List all trackings (列出多个物流信息)
//$track = $track->getTrackingsList($numbers = "RK666201171CN",$orders = "",$page = 1,$limit = 100,$createdAtMin = 0,$createdAtMax = 0,$update_time_min = 0,$update_time_max = 0,$order_created_time_min = 0,$order_created_time_max = 0,$lang = "en");

//5 Get tracking results of a single tracking (列出单个运单号物流信息)
//$track = $track->getSingleTrackingResult("ruston","RK666201171CN",'en');

//6 create muti tracking number (创建多个运单号)
//$items = array(
//    array(
//        'tracking_number' => 'RK666201171CN',
//        'carrier_code'    => 'ruston',
//        'title'          => '4PX page',
...
//$extraInfo['destination_code'] = 'US';
//$extraInfo['status']       = '7';
//$track = $track->updateTrackingItem('ruston','RK666201171CN',$extraInfo);

//8 Delete a tracking item (删除单个运单号)
//$track = $track->deleteTrackingItem('ruston','RK666201171CN');

//9 Get realtime tracking results of a single tracking (获取单个运单号实时物流信息)
// $track = $track->getRealtimeTrackingResults("ruston","RK666201171CN",array("lang"=>'en'));

//10 Modify courier code (修改运输商简码)
//$r = $track->updateCarrierCode("RK666201171CN","ruston","china-ems");
...
//$date = array();
//$data[] = array("tracking_number"=>"RK666201171CN","carrier_code"=>"ruston");
...
//$data = array();
//$data[] = array("original"=>"CN","destination"=>"US","carrier_code"=>"ruston");
